...
public class EntitySQLTest {
    final EntityClassMetaDataImpl<CommonClass> entityClass = new EntityClassMetaDataImpl<>(CommonClass.class);

    @Test
    public void testCtrWithNull() {
        assertThrows(MapperException.class, () -> new EntitySQLMetaDataImpl<Object>(null));
    }

    @Test
    public void testCtr() {
        assertDoesNotThrow(() -> new EntitySQLMetaDataImpl<CommonClass>(entityClass));
    }

    @Test
    public void testGetSelectAllSql() {
        final var entitySql = new EntitySQLMetaDataImpl<CommonClass>(entityClass);
